...
using Type = Bonsal_Gardent.Models.Type;
...
namespace Bonsal_Gardent.Controllers
{
    public class TypesController : Controller
    {
        ...
        public TypesController(Gardent_BonsalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Gardent_BonsalContext.Types'  is null.");
            }
            var @type = await _context.Types.FindAsync(id);
            if (@type != null)
            {
